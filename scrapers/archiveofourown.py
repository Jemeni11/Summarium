...
def archive_of_our_own(url: str):
    ...
    #         url += '?view_adult=true'
        ...
        # RELATIONSHIPS = ' '.join(_.get_text() for _ in soup.find('dd', class_='relationship tags').contents[1])
        CHARACTERS = ', '.join(_.get_text() for _ in soup.find('dd', class_='character tags').contents[1])[3:-3]
...
if __name__ == '__main__':
    print(archive_of_our_own('https://archiveofourown.org/works/32222176'))
